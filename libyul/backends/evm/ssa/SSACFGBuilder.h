...
private:
	...
	/// For multi-output operations the caller is responsible for naming individual results
	/// via the corresponding Extract InstIds emitted right after the operation.
